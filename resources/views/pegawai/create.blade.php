          ...
          <div class="box-body">
            <form class="form-horizontal"  action="{{ route('admin.pegawai.store') }}" method="POST">
              ...
              <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                ...
                <div class="col-sm-10">
                 <input id="email" name="email" type="text" class="form-control" placeholder="email" value="{{ old('email') }}" required="">
              ...
              <div class="form-group{{ $errors->has('birth_date') ? ' has-error' : '' }} ">
                ...
                <div class="col-sm-10">
                  <input id="datepicker" name="birth_date" type="text" class="form-control" value="{{ old('birth_date') }}" placeholder="Tanggal Lahir" required="">
