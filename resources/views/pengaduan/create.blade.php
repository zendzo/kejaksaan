      ...
      {{ csrf_field() }}
        ...
        <div class="box-body">
          <div class="form-group">
            ...
            <div class="col-sm-10">
            	<input name="no_ktp" class="form-control" placeholder="NIK KTP">
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input name="birth_date" type="text" class="form-control pull-right" id="datepicker" required="" placeholder="{{ Date('m/d/Y') }}">
            </div>
          </div>

          <div class="form-group">
            <label for="no_ktp" class="col-sm-2 control-label">No. Hp</label>

            <div class="col-sm-10">
              <input name="phone" class="form-control" placeholder="0812xxxxxxxx">
            </div>
          </div>

          <div class="form-group">
            <label for="no_ktp" class="col-sm-2 control-label">Email</label>

            <div class="col-sm-10">
              <input name="email" class="form-control" placeholder="example@mail.com">
            </div>
          </div>

          <div class="form-group">
            <label for="no_ktp" class="col-sm-2 control-label">Alamat</label>

            <div class="col-sm-10">
              <textarea name="address" class="form-control" placeholder="Jl.DI Panjaitan, Tanjungpinang"></textarea>
            </div>
          </div>
      ...
      <!-- form start -->
        ...
        <div class="box-body form-horizontal">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
               <input name="title_pengaduan" class="form-control" placeholder="Judul Pengaduan">
            </div>
          </div>
